...
const AddAJob = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const job = {
      ...
      experience,
      vacancies,
      requiredSkills: requiredSkills.split(/\s*,\s*/),
      salary,
      authorEmail,
      instructions,
      jobsDescription,
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="card-body">
          <div className="md:flex justify-center items-center gap-4">
            <div className="form-control md:w-[50%]">
              <label className="label">
                <span className="label-text card-text-secondary">
                  Job Title
                </span>
              </label>
              <input
            ...
            <div className="form-control md:w-[50%]">
              ...
              {errors.companyDetails?.type === "required" && (
                <p className="text-red-500">Company Details is required</p>
              )}
            </div>
          </div>
          <div className="md:flex justify-center items-center gap-4">
          ...
          <div className="md:flex justify-center items-center gap-4">
            <div className="form-control md:w-[50%]">
              ...
              {errors.employmentType?.type === "required" && (
                <p className="text-red-500">Job employment Type is required</p>
              )}
            </div>
          ...
          <div className="md:flex justify-center items-center gap-4">
            ...
            <div className="form-control md:w-[50%]">
              ...
              {errors.experience?.type === "required" && (
                <p className="text-red-500">Job experience is required</p>
              )}
            </div>
            <div className="form-control md:w-[50%]">
              <label className="label">
              ...
              {errors.vacancies?.type === "required" && (
                <p className="text-red-500">vacancies is required</p>
              )}
            </div>
          ...
          <div className="md:flex justify-center items-center gap-4">
            <div className="form-control md:w-[50%]">
              ...
              <input
                type="text"
                placeholder="Job requiredSkills"
                {...register("requiredSkills", { required: true })}
                className="input input-bordered"
              />
              {errors.requiredSkills?.type === "required" && (
                <p className="text-red-500">RequiredSkills is required</p>
              )}
            </div>
            <div className="form-control  md:w-[50%]">
              <label className="label">
              ...
              <input
                type="number"
                placeholder="Salary or Hourly Wage"
                {...register("salary", { required: true })}
                className="input input-bordered"
              />
              {errors.salary?.type === "required" && (
                <p className="text-red-500">Job salary is required</p>
              )}
            </div>
            <div className="form-control md:w-[50%]">
              <label className="label">
          ...
          <div className="md:flex justify-center items-center gap-4">
            <div className="form-control w-full">
              ...
              {errors.instructions?.type === "required" && (
                <p className="text-red-500">
                  Job applicationInstructions is required
                </p>
              )}
            </div>
            ...
            <div className="form-control w-full">
              ...
              <textarea
                ...
                className="textarea textarea-bordered textarea-lg "
              ></textarea>
              {errors.jobsDescription?.type === "required" && (
