    ...
    <div className="  md:flex justify-center items-center bg-orange-50">
      <div className="md:w-[50%] md:bg-white">
        <div className="mx-4 md:mx-40">
          <h2 className={`${myFont.className} text-3xl mt-5`}>
            <Link href="/">The Universal News</Link>
          </h2>
          <h2 className="text-slate-950 text-4xl my-14">
            Gain unlimited access <br />
            to all of The Times.
          </h2>
          ...
          <div>
            ...
            <form className="">
              ...
              <div className="flex gap-3 border-y border-gray-300 py-3">
                ...
                <div>
                  ...
                  <br />
                  <small className="text-sm text-gray-500">
                    Billed once for the first years.
                  </small>
                </div>
              </div>
              <button
            ...
            <div className="">
              <p className="text-stone-950 text-xs py-2 border-y mt-16 mb-3 ">
                All Access includes News, plus Games, Cooking, Wirecutter and
                The Athletic.
              </p>
              <p className="text-gray-500 text-xs">
                Offer for a The Universal news All Access subscription; current
                subscribers not eligible. Subscription excludes print edition.
                For a monthly subscription, your payment method will
                automatically be charged in advance the introductory rate every
                4 weeks for 1 year, and after 1 year the standard rate every 4
                weeks. For an annual subscription, your payment method will
                automatically be charged in advance the introductory rate for 1
                year, and after 1 year the standard rate once yearly. Your
                subscription will continue until you cancel. Cancellation takes
                effect at the end of your current billing period. Taxes may
                apply. Offer terms are subject to change. Some benefits, such as
                access to Wordle, may be available without a subscription.
              </p>
            </div>
          </div>
        </div>
